...
private:
    ...
    static constexpr uint32_t CAPTURE_HOP_INTERVAL_MS = 50;

    // Receive-side frequency hopping for MIT inverters
    bool _rxHopEnabled = false;
    uint8_t _rxHopBaseChannel = 0;
    uint8_t _rxHopLastFragId = 0;
    uint32_t _rxHopLastFragTime = 0;
